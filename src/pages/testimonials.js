...
const Testimonials = () => {
    return (
        <div 
            ...
            />
            <TestimonialCard name="Benjamin Beggs" project="Parallel Fourier Computing" headshot={benjaminBeggs} bordercolor="#c81c2e"
            ...
            />
            <TestimonialCard name="Amy Lu" project="Reeltube" headshot={amyLu} bordercolor="#fedb01"
            ...
            />
            <TestimonialCard name="Cooper Leong" project="ESPECT" headshot={cooperLeong} bordercolor="#00205B"
            ...
            />
            <TestimonialCard name="Jacob Laframboise" project="No Spoiling!" headshot={jacobLaframboise} bordercolor="#00205B"
